...
| **sourccey** | — | planar (wheels) + lift | yes | strip-replace + spawn guards | `GenericZmqClient` (stub) | [sourccey.md](sourccey.md) — Vulcan Robotics; vendored MJCF from STEP CAD + official `ArmLeft.urdf` |
