...
- **[2026-08-22_tamp_agent_tools.md](2026-08-22_tamp_agent_tools.md)** – Semantic CHAT TAMP tools, simulator grounding boundary, guarded execution, and acceptance criteria (**offline green; managed gate partial — see plan status table**).
- **Graph room evidence (eval):** [../experiments/graph_room_evidence.md](../experiments/graph_room_evidence.md) – agent-visible room timeline A/B (branch `feature/graph-room-evidence`); no escape latch.
