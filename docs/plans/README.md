...
- **[2026-08-08_embodied_agent_planning.md](2026-08-08_embodied_agent_planning.md)** – World model + tool calling + motion: action-outcome ledger in graph memory, shared tool-outcome schema, narrow planner interface, no-regression eval gates (branch `feature/agent-world-model`).
