...
| **TAMP clutter** | `sec:tamp_clutter` | [tamp_clutter.md](tamp_clutter.md) | `uv run python scripts/eval_tamp_clutter.py --smoke` | `~/runs/emet/tamp_clutter` | per-episode JSON + `aggregate_tamp_clutter.csv` |
