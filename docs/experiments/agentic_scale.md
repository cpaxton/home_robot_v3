...
| 3 | Full 113 classic dynagraph + `graph_eqa`; agentic 113 only if claiming letter win | **IN PROGRESS** — post-nav Qwen3-VL-8B sweep (dynagraph + static_graph) running 2026-08-13, job `hmeqa-paper113-d1`; agentic-113 still optional |
