...
Dynagraph profiles follow \texttt{configs/benchmarks/dynagraph.yaml}: \texttt{interactive} (0.45\,m merge, staleness 256) vs.\ \texttt{static\_graph} (merge/staleness off).
