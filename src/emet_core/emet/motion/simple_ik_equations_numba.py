                ...
                + (
                    ...
                    + (
                        ...
                        * (
                            ...
                            + (
                                a1 * b1 * l3 * (2 * l1 * x + l2 * y)
                                + (-1 * a1 * l1 * (l1 * x + l2 * y) * z + -1 * a2 * l2 * (l1 * x + l2 * y) * z)
                            )
                        )
                        + a3
                        * (
                    ...
                    + (
                        ...
                        * (
                            ...
                            + (
                                ...
                                * l3
                                * y
                                * (b1 * l3 * (2 * l1 * x + 3 * l2 * y) + 2 * l1 * (l1 * x + l2 * y) * z)
                                + (
                                    2
                                    * a1
                                    * a2
...
def calibrated_ik_with_prismatic_base(wrist_position, b1, l_vector, a_vector):
    ...
    # base translation (mu)
    M = (
        a1 * ((l2 * z) - (l3 * y)) + a2 * ((-b1 * l3) - (l1 * z) + (l3 * x)) + a3 * ((b1 * l2) + (l1 * y) - (l2 * x))
    ) / denominator
    # lift (lambda)
