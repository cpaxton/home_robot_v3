...
# Resolve config paths relative to this package (emet)
_emet_root = Path(__file__).resolve().parent.parent
CONFIG_ROOT = str(_emet_root / "config")
CONTROL_CONFIG_DIR = str(_emet_root / "config" / "control")
DATA_ROOT = str(_emet_root.parent.parent / "data")
