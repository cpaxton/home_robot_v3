...
from emet.perception.detection.scannet_200_classes import CLASS_LABELS_200
...
class OWLSAMProcessor(OwlPerception):
    ...
    def reset_vocab(self, texts: list[str] | None = None):
        if texts is None:
    ...
    def draw_bounding_box(self, image: type[Image.Image], bbox: list[int], save_file: str = None) -> None:
    ...
    def draw_mask_on_image(self, image: type[Image.Image], seg_mask: np.ndarray, save_file: str = None) -> None:
