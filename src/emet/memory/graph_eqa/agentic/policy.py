...
class EvidencePhase(str, Enum):
    """FSM phase for ``EvidencePolicy`` (not the prompt snapshot in ``agentic.state``)."""
...
EvidenceRecord = ChannelEvidence
...
class EvidencePolicy:
    ...
    def add_evidence(self, record: ChannelEvidence) -> None:
