...
def graph_room_at_robot(self, robot_xy: Any) -> str:
    ...
    from emet.memory.graph_eqa.spatial.room_clusters import estimate_room_at_xy
...
def format_rooms_line(self, *, max_chars: int = 200) -> str:
    ...
    from emet.memory.graph_eqa.spatial.room_clusters import format_rooms_compact
...
def stamp_vlm_room_at_robot(
    ...
    *,
    ...
    """
    from emet.memory.graph_eqa.spatial.room_clusters import estimate_room_at_xy, stamp_room_at_xy
    from emet.memory.graph_eqa.spatial.room_labels import sanitize_room_phrase
...
def record_room_event(
    ...
    *,
    ...
    """
    from emet.memory.graph_eqa.spatial.room_clusters import normalize_current_room
