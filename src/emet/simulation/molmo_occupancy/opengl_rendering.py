...
from emet.simulation.molmo_occupancy.abstract_renderer import MjAbstractRenderer, MultithreadRenderer
...
class MultithreadOpenGLRenderer(MultithreadRenderer):
    ...
    def render(
        ...
        for idx, (model, data) in enumerate(zip(self.env.mj_models, self.env.mj_datas, strict=True)):
