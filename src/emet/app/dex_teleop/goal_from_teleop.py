...
import emet.app.dex_teleop.dex_teleop_parameters as dt
...
class GoalFromMarkers:
    ...
    def __init__(self, teleop_origin, initial_center_wrist_position, slide_lift_range=False):
        ...
        print(f"GoalFromMarkers: self.tongs_min_dist_from_camera = {self.tongs_min_dist_from_camera * 100.0:.2f} cm")
        print(f"GoalFromMarkers: self.tongs_max_dist_from_camera = {self.tongs_max_dist_from_camera * 100.0:.2f} cm")
        print(f"GoalFromMarkers: self.sliding_region_height = {self.sliding_region_height * 100.0:.2f} cm")
        ...
        print(f"GoalFromMarkers: self.tongs_lift_range = {self.tongs_lift_range * 100.0:.2f} cm")
        ...
        print(f"self.min_lift_range_offset = {self.min_lift_range_offset * 100.0:.2f} cm")
        print(f"self.max_lift_range_offset = {self.max_lift_range_offset * 100.0:.2f} cm")
            ...
            if grip_pose_marker is not None:
                ...
                if tongs_at_valid_distance_from_camera:
                    ...
                    if self.slide_lift_range and command_to_slide_lift_range:
                        ...
                        print(f"self.lift_range_offset = {self.lift_range_offset * 100.0:.2f} cm")
                    else:
                    ...
                    if grip_width_marker is not None:
                        ...
                        goal_grip_width = (
                            np.clip(grip_width, self.min_finger_width, self.max_finger_width) - self.min_finger_width
