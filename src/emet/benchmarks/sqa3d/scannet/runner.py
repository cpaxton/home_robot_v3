...
"""Run SQA3D episodes with emet GraphEQA / Dynagraph on ScanNet meshes."""
...
def run_sqa3d_episode(
    *,
    ...
    sim = ScanNetEQASimulator.from_scene_id(q.scene_id, scannet_root=scannet_root or default_scannet_root())
    ...
    try:
        ...
        em, em_refined = answer_match(pred_clean, gts) if gts else (False, False)
