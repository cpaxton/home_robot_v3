...
setuptools.setup(
    ...
    install_requires=[
        ...
        "retry",
        "qwen_vl_utils",
        "bitsandbytes; platform_machine != 'aarch64'",
        "triton >= 2.3.1; platform_machine != 'aarch64'",
        "accelerate >= 1.6.0",
        "einops",
        "protobuf",
        # Compression tools
        ...
        "scikit-fmm",
        "open3d>=0.17.0,<0.19; platform_machine == 'aarch64'",
        "open3d; platform_machine != 'aarch64'",
        "depth-anything-3>=0.1.1; platform_machine != 'aarch64'",
        "click>=8.1.8",
        "discord.py",
        "python-dotenv",
    ],
