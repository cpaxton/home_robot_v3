...
Usage::
  ...
  uv run python scripts/hmeqa_significance.py ~/runs/emet/hmeqa_agentic_bal32_...
  uv run python scripts/hmeqa_significance.py --from-summary paper/data/.../balanced32_summary.json \\
